  ...
  return (
    <div className="fixed bg-black/50 right-0 left-0 top-0 bottom-0">
      <div className="flex flex-col items-center justify-center h-screen p-6">
        <div className="relative flex flex-col justify-center items-center w-10/12 mx-auto sm:w-72 px-2 py-8 border border-gray-200 rounded-3xl shadow-md bg-white">
          <button
            onClick={() => {
              closeLoginModal();
              removeUnscroll();
